    ...
    <div style={{ minHeight: '100vh', background: COLORS.bg, color: COLORS.paper, fontFamily: FONT_BODY, padding: 24, display: 'grid', placeItems: 'center' }}>
      <div style={{ width: '100%', maxWidth: 620, background: COLORS.panel, border: `1px solid ${COLORS.line}`, borderRadius: 20, padding: 28, boxShadow: '0 20px 60px rgba(0,0,0,.35)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 22 }}>
          ...
          <div>
            <div style={{ fontFamily: FONT_DISPLAY, fontSize: 26, textTransform: 'uppercase' }}>Garage Log</div>
            <div style={{ color: COLORS.steel, fontSize: 15 }}>Firebase configuration is missing</div>
          </div>
        </div>

        <div style={{ padding: 14, borderRadius: 12, background: COLORS.rustDim, border: `1px solid ${COLORS.rust}55`, color: COLORS.rust, fontSize: 15, lineHeight: 1.55, marginBottom: 22 }}>
        ...
        <div style={{ display: 'grid', gap: 10, marginBottom: 22 }}>
          {steps.map((step, i) => (
            <div key={step} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', fontSize: 15, color: COLORS.steel }}>
        ...
        <div style={{ background: COLORS.bg, border: `1px solid ${COLORS.line}`, borderRadius: 12, padding: 15, marginBottom: 18 }}>
          <div style={{ display: 'flex', gap: 8, alignItems: 'center', color: COLORS.blue, fontSize: 14, fontWeight: 700, marginBottom: 8 }}>
            <Terminal size={15} /> TERMINAL
          </div>
          <code style={{ color: COLORS.paper, fontSize: 14, lineHeight: 1.7 }}>
        ...
        <a href="https://console.firebase.google.com/" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: COLORS.blue, fontSize: 15, fontWeight: 700, textDecoration: 'none' }}>
